...
export const columns = ({ onAction: _onAction }: ColumnsProps): ColumnDef<App>[] => [
  {
    accessorKey: 'name',
    header: 'App',
    cell: ({ row }) => (
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="text-right">
          <Button asChild variant="outline" size="sm" className="border-emerald-400/20 bg-emerald-500/[0.08] px-2.5 text-emerald-100 hover:bg-emerald-500/[0.16]">
            <Link href={`/android-app-settings/${app.id}/edit`}>
