...
const debitCategories: Tag[] = ['Business', 'Personal', 'Unknown'];
const creditCategories: Tag[] = ['IOS Income', 'Android Income', 'Admob Income', 'Other'];

const columns: ColumnDef<PfcTransaction>[] = [
    {
...
interface StatementTableProps {
  ...
  setParsedData: React.Dispatch<React.SetStateAction<{ fileName: string; transactions: PfcTransaction[] } | null>>;
}
